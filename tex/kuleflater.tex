...
eksempel 38
 ...
 \begin{align*}
	 \left(x-x_0\right)^2 + \left(y-y_0\right)^2 + \left( z-z_0 \right)^2 &= r^2 \\
	 \left(x-0\right)^2 + \left(y-4\right)^2 + \left(z+3\right)^2 &= 3^2 \\
	 x^2 + \left(y-4\right)^2 + \left(z+3\right)^2 = 9
 .\end{align*}

 \qs{c}{sentrum i $\left( 1,2,3 \right) $ og radius $\sqrt{7} $}
 \sol 
 \begin{align*}
	 \left( x-x_0 \right)^2 + \left( y-y_0 \right)^2 + \left( z-z_0 \right)lr &= r^2 \\
	 \left( x-1 \right)^2 + \left( y-2 \right)^2 + \left( z-3 \right) &= \sqrt{7}^2 \\
	 \left( x-1 \right)^2 + \left( y-2 \right)^2 + \left( z-3 \right)^2 &= 7
 .\end{align*}

 \qs{d}{sentrum i $\left( 2,3,4 \right) $ og som går gjennom $\left( 3,4,6 \right) $}
 \sol 
 \begin{align*}
	 r = \sqrt{\left( 3-2 \right)^2 + \left( 4-3 \right)^2 + \left( 6-4 \right)^2   } &= \sqrt{6}  \\ 
	 \left( x-2 \right)^2 + \left( y-3 \right)^2 + \left( z-4 \right) &= 6
 .\end{align*}

 \section{5.110} 
 \qs{undersøk hordan punktet $\left( 5,-4,8 \right) $ ligger i forhold til kuleflaten gitt ved}{$x^2 + y^2 + z^2 = 82$}
 \begin{align*}
	 5^2 + \left( -4 \right)^2 + 8^2 &= 
 .\end{align*}
