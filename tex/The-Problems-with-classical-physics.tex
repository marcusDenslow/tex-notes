...
A black body is one that absorbs all the EM radiation (light\ldots) that strikes it. To stay in thermal equilibrium, it must emit radiation at the same rate as it absorbs it so a black body also radiates will. (That's why stoves are black). Radiation from a hot object is 
