...
\\
\begin{equation}
	\boxed{ \boxed{\mathbf{H} = \sum_{k, \alpha} \left( \frac{\omega}{c} \right)^2 \left[ c_{k,\alpha} c^{*}_{k, \alpha} + c^{*}_{k, \alpha} c_{k, \alpha} \right]   } \\ 
	\boxed{Q_{k, \alpha} = \frac{1}{c} \left( c_{k, \alpha} + c^{*}_{k, \alpha} \right) }  } 
\end{equation}
