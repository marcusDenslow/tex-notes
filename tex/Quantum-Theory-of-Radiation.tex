...
\\
\\
This is just the same as the Hamiltonian that we had for the one dimensional harmonic oscillator. We therefore have the raising and lowering operators, as long as $\displaystyle \left[ a_{k, \alpha}, a^{\dagger}_{k, \alpha} \right] = 1$
