...
\\
\\
These give the same result as our earlier guess to put an $\displaystyle n+1$ in the emission operator.something


\begin{align*}
	\left< n \left| \mathbf{H}_{int} \right|i \right> &= \left<\psi_{n}; n_{\vec{k}, \alpha} +1 \left| - \frac{e}{mc} \vec{A} \cdot \vec{p}  \right| \psi_{i}; n_{\vec{k}, \alpha} \right> \\
	\left<n \left| \mathbf{H}^{\left( emit \right) }_{int} \right| i \right> &= -\frac{e}{mc} \frac{1}{\sqrt{V} } \sqrt{\frac{\hbar c^2}{2\omega}} \left<\psi_{i}; n_{\vec{k}, \alpha} + 1 \left| \hat{\epsilon}^{\left( \alpha \right) } \cdot \vec{p} a^{\dagger}_{k, \alpha} \left( 0 \right) e^{-ik_{p}x_{p}} \right| \psi_{i}; n_{\vec{k}, \alpha} \right> \\
	&= -\frac{e}{m} \frac{1}{\sqrt{V} } \sqrt{\frac{\hbar c^2}{2\omega}}  \left<\psi_{i}; n_{\vec{k}, \alpha} + 1 \left|\hat{\epsilon}^{\left( \alpha \right) } \cdot \vec{p} a^{\dagger}_{\vec{k}, \alpha} \left( 0 \right) e^{-ik_{p}x_{p}}  \right| \psi_{i}; n_{\vec{k}, \alpha} \right>
.\end{align*}
