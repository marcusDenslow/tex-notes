...
\begin{align*}
	...
	&= -\frac{e}{m} \frac{1}{\sqrt{V} } \sqrt{\frac{\hbar \left( n_{\vec{k}, \alpha} + 1 \right) }{2\omega}} \left<\psi_{n} \left|e^{-ik_{p}x_{p}} \hat{\epsilon}^{\left( \alpha \right) } \cdot \vec{p}\right| \psi_{i} \right> e^{i \omega t}
.\end{align*}
