...
\begin{equation}
	\boxed{
		\begin{gathered}
			\boxed{\makebox[0.75\textwidth]{$\displaystyle \mathbf{H} = \sum_{k, \alpha} \left( \frac{\omega}{c} \right)^2 \left[ c_{k,\alpha} c^{*}_{k, \alpha} + c^{*}_{k, \alpha} c_{k, \alpha} \right]$}} \\[1em]
			\boxed{\makebox[0.75\textwidth]{$\displaystyle Q_{k, \alpha} = \frac{1}{c} \left( c_{k, \alpha} + c^{*}_{k, \alpha} \right)$}} \\[1em]
			\boxed{\makebox[0.75\textwidth]{$\displaystyle P_{k, \alpha} = - \frac{i \omega}{c} \left( c_{k, \alpha} - c^{*}_{k, \alpha} \right)$}} \\[1em]
			\boxed{\makebox[0.75\textwidth]{$\displaystyle H = \frac{1}{2} \sum_{k, \alpha} \left[ P^2_{k, \alpha} + \omega^2 Q^2_{k, \alpha} \right]$}}
		\end{gathered}
	}
\end{equation}
