...
\begin{equation}
    \left| n_{k_1, \alpha_1}, n_{k_2, \alpha_2}, \dots, n_{k_{i}, \alpha_{i}}, \dots \right> = \Pi_{i} \frac{\left( a^{\dagger}_{k_{i}, \alpha_{i}} \right)^{n_{k_{i}, \alpha_{i}}} }{\sqrt{n_{k_{i}, \alpha_{i}}!} }
\end{equation}
