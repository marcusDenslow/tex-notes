...
.\end{align*}
In our calculation of the total decay rate summed over polarization and integrated over photon direction we computed the cosine of the angle between each polarization vector and the (vector)
