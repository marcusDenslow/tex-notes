...
\begin{align*}
	H_{\text{int}} &= \sum_{\vec{k}, \alpha} \left( H^{\text{abs}}_{\vec{k}, \alpha} e^{-i \omega t} + H^{\text{emit}}_{\vec{k}, \alpha} e^{ i \omega t} \right) \\
	H^{\text{abs}} = -\sqrt{\frac{\hbar e^2}{2m^2 \omega V}} a_{\vec{k}, \alpha} e^{i \vec{k} \cdot \vec{x}} \vec{p} \cdot \hat{\epsilon}^{(\alpha)}
.\end{align*}
