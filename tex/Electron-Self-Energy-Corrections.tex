...
\begin{align*}
	...
	&= \frac{e^2}{\left( 2\pi \right)^3 2m^2 } \sum_{\alpha} \sum_{j}  \int d \Omega \,\frac{k^2 dk}{\omega} \frac{\left| n \left<n \left| e^{i \vec{k} \cdot \vec{x}}\vec{p} \cdot \hat{\epsilon}^{(\alpha)} \right|j  \right> \right|^2 }{\left( \omega_{nj} - \omega \right) }
.\end{align*}
