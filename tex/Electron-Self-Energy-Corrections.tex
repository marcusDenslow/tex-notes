...
\begin{align*}
	\Delta E_{\text{free}} &= \frac{2 \alpha \hbar}{3 \pi m^2 c^2 V^2} \sum_{\vec{p}'} \int \frac{\omega}{\left( \omega_{nj} - \omega \right) } \left| \int e^{-i \vec{p} \cdot \vec{x} / \hbar} \vec{p} e^{i \vec{p}' \cdot \vec{x} / \hbar} d^3  \right| d\omega
.\end{align*}
