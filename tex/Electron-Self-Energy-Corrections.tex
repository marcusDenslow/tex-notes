...
It's easy to see that this will go to negative infinity if the limit on the integral is infinite. It is quite reasonable to cut off the integral at some enrgy beyond which the theory we are using is invalid. Since we are still using non-relativistic quantum mechanics, the cut-off should have $\displaystyle \hbar \omega \ll mc^2$
