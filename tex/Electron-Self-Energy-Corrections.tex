...
\begin{align*}
	...
	c_{j}\left( t \right)  &= \sum_{\vec{k}, \alpha} \mathbf{H}_{jn} \frac{e^{i \left( - \omega_{nj} - \Delta \omega_{n} + \omega \right) t - 1 }}{\hbar \left( \omega_{nj} + \Delta \omega_{n} - \omega \right) } \\
	i\hbar \frac{dc_{n}}{dt} = \Delta E_{n} e^{-i \Delta E_{n} t / \hbar} = \sum_{\vec{k}, \alpha} \sum_{j} \mathbf{H}_{nj} \mathbf{H}_{jn} e^{-i \omega t} e^{i \omega_{nj} t} \frac{e^{i \left( - \omega_{nj} - \Delta \omega_{n} + \omega \right) t - 1 }}{}
.\end{align*}
