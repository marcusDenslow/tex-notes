...
\\
\\
For a definite initial state polarization at an angle $\displaystyle \phi$ to the scattering plane, the component along $\displaystyle \hat{\epsilon}^{(1)} \text{ is } \cos \phi \text{ and along } \hat{\epsilon}^{(2)} \text{ is } \sin \phi$
