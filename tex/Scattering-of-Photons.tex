...
\begin{align*}
	...
	&\left. e^{i \left( \omega_{nj} - \omega \right)t_2 } \left<n \left| \hat{\epsilon} \cdot \vec{p} \right|j  \right> \left<j \left| \hat{\epsilon}' \cdot \vec{p} \right|i  \right> lr[\frac{e^{i \left( \omega' + \omega_{ji} \right)t_2 }-1}{i \left( \omega' + \omega_{ji} \right) }    \right]
.\end{align*}
