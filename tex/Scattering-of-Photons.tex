...
\begin{align*}
	...
	\\
	\\
	\Gamma &= \int \frac{Vd^3 k'}{\left( 2\pi \right)^3 } \left| \delta_{ni} \hat{\epsilon} \cdot \hat{\epsilon'} - \frac{1}{m \hbar} \sum_{j}  \left[ \frac{\left<n \left| \hat{\epsilon'} \cdot \vec{p} \right|j  \right> \left<j \left| \hat{\epsilon} \cdot \vec{p} \right|i  \right>}{\omega_{ji} - \omega} + \frac{\left<n \left| \hat{\epsilon} \cdot \vec{p} \right|j  \right> \left<j \left| \hat{\epsilon'} \cdot \vec{p} \right|i  \right>}{\omega' + \omega_{ji}} \right]  \right|  \, dx
.\end{align*}
