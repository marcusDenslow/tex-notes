...
\begin{align*}
	...
	c^{\left( 2 \right) }_{n} \left( t \right) &= -\frac{1}{\hbar^2} \sum_{j, \vec{k}, \alpha}  \int_{0}^{t} dt_2 \mathcal{V}_{nI} \left( t_2 \right) e^{ i \omega_{nj} t_2} \int_{0}^{t_2} dt_1 e^{i \omega_{ji}t_1}\mathcal{V}_{Ii} \left( t_1 \right)  \, dx   \, dx 
.\end{align*}
