...
\begin{equation}
	\boxed{\frac{d \sigma_{elas}}{d \Omega} = \left( \frac{e^2}{4\pi mc^2} \right)^2 \left( \frac{m \omega}{\hbar} \right)^2 \left| \sum_{j}  \omega_{ji} \left[ \frac{\left<i \left| \hat{\epsilon'} \cdot \vec{x} \right|j  \right> \left<j \left| \hat{\epsilon} \cdot \vec{x} \right| i \right>}{\omega_{ji} - \omega} \right] ] \right|  }
\end{equation}
