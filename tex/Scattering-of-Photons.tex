...
\\
\begin{equation}
	\frac{d \sigma}{d \Omega} = \left( \frac{e^2}{4\pi mc^2} \right)^2 \frac{1}{2} \left( \cos^2 \theta \cos^2 \phi + \sin^2 \phi \right) 
\end{equation}
\\
\\
For atoms with more than one electron, this cross section will grow as $\displaystyle Z^{4}$
