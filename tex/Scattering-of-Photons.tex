...
\begin{equation}
	\frac{d \sigma}{d \Omega} = \left( \frac{e^2}{4 \pi mc^2} \right)^2 \left( \frac{\omega'}{\omega} \right) \left| \delta_{ni}\hat{\epsilon} \cdot \hat{\epsilon'} - \frac{1}{m \hbar} \sum_{j} \left[ \frac{\left<n \left| \hat{\epsilon'} \cdot \vec{p} \right|j  \right> \left<j \left| \hat{\epsilon} \cdot \vec{p} \right| i \right>}{\omega_{ji}- \omega}  \frac{\left<n \left| \hat{\epsilon} \cdot \vec{p} \right| j \right> \left<j \left| \hat{\epsilon'} \cdot \vec{p} \right| i \right>}{\omega_{ji} + \omega'} \right]  \right| 
\end{equation}
