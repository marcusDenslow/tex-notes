...
\begin{align*}
	...
	&= \left[ \frac{-i}{m \omega_{ij}} \left( \hat{\epsilon} \cdot \vec{p} \right)_{ij} \left( \hat{\epsilon'}\cdot \vec{p} \right)_{ji} + \frac{-i}{m \omega_{ij}} \left( \hat{\epsilon'} \cdot \vec{p} \right)_{ij} \left( \hat{\epsilon} \cdot \vec{p} \right) _{ji} \right]
.\end{align*}
