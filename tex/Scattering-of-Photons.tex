...
eh, kinda. its more like having a multi-dimensional vector/vectors and then they kinda give like a normal distribution of their output. and when measured it picks the one with the highest probability. well not infinity dimensions vector but very high-dimensional vector. well just dont think of a vector like an arrow. think of it like a list/wieght. like this
<1, 2, 3, 4, 5, 6, 7, 8, 9> so like a qbit would look like this before measured.
<0, 0.1, 0, 0.4, 0.5. 0.75, 0.3,> you understand? its like a normalized vector. every index represents something, and the number you see represents a weight of being that index.
   a, b, c, d, e, f, g
  <0.03, 0.1, 0.3, 0.7, 0.04, 0.3, 0.1> 

  like this, every index of the vector represented by < > is the probability of that letter. 
