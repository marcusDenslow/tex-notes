...
\begin{align*}
	...
	&= \frac{e^2}{mc^2} \frac{1}{V} \frac{\hbar c^2}{2 \sqrt{\omega' \omega} } \epsilon^{\left( \alpha \right) }_{\mu} \epsilon^{\left( \alpha' \right) }_{\mu} e^{-i \left( \omega - \omega' \right)t } \left<n; \vec{k}' \hat{\epsilon}^{\left( \alpha' \right) \left| 2 \right|i; \vec{k}' \hat{\epsilon}^{\left( \alpha' \right) }  } \right>
.\end{align*}
