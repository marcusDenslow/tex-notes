...
\begin{align*}
	...
	&= \left( \frac{e^2}{4\pi mc^2} \right)^2 \left( \frac{m \omega}{\hbar} \right)^2 \left| \sum_{j} \left[ \left( \left<i \left| \hat{\epsilon'} \cdot \vec{x} \right| j \right> \left<j \left| \hat{\epsilon} \cdot \vec{x} \right| i \right> - \left<i \left| \hat{\epsilon} \cdot \vec{x} \right| j \right> \left<j \left| \hat{\epsilon'} \cdot \vec{x} \right| i \right> \right) // + \frac{\omega}{\omega_{ji}} \left( \left<i \left| \hat{\epsilon'} \cdot \vec{x} \right| j \right> \left<j \left| \hat{\epsilon} \cdot \vec{x} \right| i \right> + \left<i \left| \hat{\epsilon}\cdot \vec{x} \right| j \right> \left<j \left| \hat{\epsilon'} \cdot \vec{x} \right| i \right> \right)  \right]  \right|^2
.\end{align*}
