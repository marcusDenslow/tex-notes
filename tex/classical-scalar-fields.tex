...
\begin{align*}
    ...
    \frac{ \partial  }{ \partial x } \left( \frac{ \partial \mathcal{L } }{ \partial \left( \partial \upeta / \partial x \right)  }  \right) + \frac{ \partial  }{ \partial t } \left(  \partial \upeta / \partial x \right) 
.\end{align*}
